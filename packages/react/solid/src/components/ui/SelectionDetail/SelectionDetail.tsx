...
import { HTMLContainer } from "~/options/solid/src/components";
import { TAU } from "~/options/solid/src/constants";
import { GeomUtils } from "@tldraw/core";
import type { TLSolidShape } from "~/options/solid/src/lib";
import type { TLSelectionDetailProps } from "~/options/solid/src/types/component-props";
import Vec from "@tldraw/vec";

export const SelectionDetail = function SelectionDetail<S extends TLSolidShape>({
  bounds,
  shapes,
  scaledBounds,
  detail = "size",
