...
import type { TLSelectionComponentProps } from "~/options/solid/src/types";
import { RotateCornerHandle } from "./handles/RotateCornerHandle.tsx";

export const SelectionForeground = function SelectionForeground<S extends TLSolidShape>({
  bounds,
  zoom,
  showResizeHandles,
  showRotateHandles
